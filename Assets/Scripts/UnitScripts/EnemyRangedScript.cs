...
public class EnemyRangedScript : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        else if (isIdle || isAttackingBuilding || isAttackingUnit)
        {
            ...
            _animator.SetBool(AnimStateList.IS_MOVING_DOWN_ENEMY_RANGED, false);
            _animator.SetBool(AnimStateList.IS_MOVING_UP_ENEMY_RANGED, false);
            _animator.SetBool(AnimStateList.IS_MOVING_LEFT_ENEMY_RANGED, false);
            _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_ENEMY_RANGED, false);
            _animator.SetBool(AnimStateList.IS_IDLE_ENEMY_RANGED, true);
        }
    ...
    private void checkAnimation(Vector2 direction)
    {
        if (Mathf.Abs(direction.x) > Mathf.Abs(direction.y))
        {
            if (direction.x > 0)
            {
                ...
                _animator.SetBool(AnimStateList.IS_MOVING_UP_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_ENEMY_RANGED, true);
            }
            else
            {
                _animator.SetBool(AnimStateList.IS_MOVING_DOWN_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_UP_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_ENEMY_RANGED, true);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_ENEMY_RANGED, false);
            }
            _animator.SetBool(AnimStateList.IS_IDLE_ENEMY_RANGED, false);
        }
        else
        {
            if (direction.y > 0)
            {
                _animator.SetBool(AnimStateList.IS_MOVING_DOWN_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_UP_ENEMY_RANGED, true);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_ENEMY_RANGED, false);
            }
            else
            {
                _animator.SetBool(AnimStateList.IS_MOVING_DOWN_ENEMY_RANGED, true);
                _animator.SetBool(AnimStateList.IS_MOVING_UP_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_ENEMY_RANGED, false);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_ENEMY_RANGED, false);
            }

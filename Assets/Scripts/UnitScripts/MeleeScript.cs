...
public class MeleeScript : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        else if (isIdle || isAttackingBuilding || isAttackingUnit)
        {
            ...
            _animator.SetBool(AnimStateList.IS_MOVING_DOWN_MELEE, false);
            _animator.SetBool(AnimStateList.IS_MOVING_UP_MELEE, false);
            _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_MELEE, false);
            _animator.SetBool(AnimStateList.IS_MOVING_LEFT_MELEE, false);
            _animator.SetBool(AnimStateList.IS_IDLE_MELEE, true);
        }
    ...
    private void CheckEnemyUnitLocation()
    {
        ...
        if (lastEnemyUnit)
        {
            ...
            // update the unit path because units are dynamic
    ...
    private void checkAnimation(Vector2 direction)
    {
        if (Mathf.Abs(direction.x) > Mathf.Abs(direction.y))
        {
            if (direction.x > 0)
            {
                _animator.SetBool(AnimStateList.IS_MOVING_DOWN_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_UP_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_MELEE, true);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_MELEE, false);
            }
            else
            {
                ...
                _animator.SetBool(AnimStateList.IS_MOVING_UP_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_MELEE, true);
            }
            _animator.SetBool(AnimStateList.IS_IDLE_MELEE, false);
        }
        else
        {
            if (direction.y > 0)
            {
                _animator.SetBool(AnimStateList.IS_MOVING_UP_MELEE, true);
                _animator.SetBool(AnimStateList.IS_MOVING_DOWN_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_MELEE, false);
            }
            ...
            {
                _animator.SetBool(AnimStateList.IS_MOVING_DOWN_MELEE, true);
                _animator.SetBool(AnimStateList.IS_MOVING_UP_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_RIGHT_MELEE, false);
                _animator.SetBool(AnimStateList.IS_MOVING_LEFT_MELEE, false);
            }

...
public class PlatinumScript : MonoBehaviour
{
    ...
    private int currentResourceAmount = ResourceAmountList.PLATINUM_AMOUNT;
    private int maxResourceAmount = ResourceAmountList.PLATINUM_AMOUNT;
    private int moreResourceAmount = (int)((float)ResourceAmountList.PLATINUM_AMOUNT * 0.66);
    private int lessResourceAmount = (int)((float)ResourceAmountList.PLATINUM_AMOUNT * 0.33);

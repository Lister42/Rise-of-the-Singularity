...
public class EnemyBuildingScript : MonoBehaviour
{
    ...
    private bool isEnemyCore = false;
    private bool isEnemyOutpost = false;
    ...
    private void DecipherTypeOfEnemyBuilding()
    {
    ...
    private void CheckHitpoints()
    {
        if (currentHitpoints <= 0)
        {
            ...
            else if (isEnemyOutpost)
            {
                transform.GetComponent<EnemyOutpostScript>().IsDestroyed();
            }
            IsDestroyed();
            Destroyed();
        }
